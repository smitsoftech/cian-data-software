...
// Dummy addToCart function — Replace with your actual logic/context
 ...
 const handleProductClick = (name,id) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6 text-center">Beauty Products</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-6">
        {products.length > 0 ? (
          ...
          <p className="col-span-full text-center">No beauty products found.</p>
        )}
      </div>
    </div>
  );
